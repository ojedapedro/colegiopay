...
export const sheetService = {
  ...
  isValidConfig() {
    ...
    return url !== '' && url.startsWith('https://script.google.com/macros/s/AKfycbzmQ_G7pgq-2vfci-NF3rf3pQPE5uQgy48gR9_28T_B6vE6G5W4leg8CE77XKusYaxt/exec') && url.endsWith('/exec');
  },
